import 'package:ecommerce/pages/createAcount.dart';
import 'package:ecommerce/pages/feed.dart';
          ...
          children: [
            ...
            Text(
              ...
              style: Theme.of(context)
                  .textTheme
                  .bodySmall, // Updated deprecated caption to bodySmall
            ),
          ],
        ),
        actions: [
          ...
          IconButton(
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        NotificationPage()), // Navigate to CreateAccountPage
              );
            },
      ...
      body: ListView(
        ...
        children: [
          ...
          Text(
            ...
            style: Theme.of(context)
                .textTheme
                .titleLarge, // Updated deprecated headline6 to titleLarge
          ),
